...
public class Bar {
    ...
    public Bar(int mColor, String mName, float mValue) {
		this.mColor = mColor;
		this.mName = mName;
		this.mValue = mValue;
	}

	public Bar(int mColor, String mName, float mValue, String mValueString) {
		this.mColor = mColor;
		this.mName = mName;
		this.mValue = mValue;
    ...
    public int getSelectedColor() {
        if (-1 == mSelectedColor) mSelectedColor = darkenColor(mColor);
